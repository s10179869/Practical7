...
public class MainActivity extends AppCompatActivity {
    ...
    public void onLogin(View v) {
        ...
        Pattern passPattern = Pattern.compile("^(?=.*[A-Za-z])(?=.*[0-9])(?=.*\\W).*$");
        Matcher passMatcher = passPattern.matcher(passInput);
        Toast ttValid = Toast.makeText(this, "Valid", Toast.LENGTH_LONG);
        Toast ttInvalid = Toast.makeText(this, "Invalid", Toast.LENGTH_LONG);
